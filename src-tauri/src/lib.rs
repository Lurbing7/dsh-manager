...
/// Tray icons are flat single-colour silhouettes so they blend with the taskbar
/// the way the built-in Windows glyphs do (transparent background, no disc).
/// Four combinations: harness state x taskbar theme. Generated by tools/make_icons.py.
